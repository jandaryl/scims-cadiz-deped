...
class SchoolController extends BackendController
{
    ...
    public function store(StoreSchoolRequest $request)
    {
        ...
        $this->schools->store($request->input(), $request->file('featured_image'), $request->file('logo_image'));
    ...
    public function update(School $school, UpdateSchoolRequest $request)
    {
        ...
        $this->schools->update($school, $request->input(), $request->file('featured_image'), $request->file('logo_image'));
