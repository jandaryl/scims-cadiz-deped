<footer class="footer mt-12" id="footer">
  <div class="columns">
    <div class="column">
    ...
    <div class="column">
      <div class="flex flex-col items-center">
        ...
        <div class="inline-flex lg:h-12 md:h-16 h-10 w-auto bg-green-lightest border border-green-light text-green-dark px-3 md:py-1 py-3 rounded-lg relative mt-2" role="alert">
          <span class="block md:inline lg:pt-2 pb-2 md:pt-1 sm:pt-0 lg:text-lg md:text-base text-sm">{{ $message }}</span>
          <span class="px-2 py-1 lg:pt-2 pb-2 md:pt-1 pt-0" data-dismiss="alert">
        ...
        <div class="inline-flex lg:h-12 md:h-16 h-10 w-auto bg-red-lightest border border-red-light text-red-dark px-3 md:py-1 py-3 rounded-lg relative mt-2" role="alert">
          <span class="block md:inline lg:pt-2 pb-2 md:pt-1 sm:pt-0 lg:text-lg md:text-base text-sm">{{ $message }}</span>
          <span class="px-2 py-1 lg:pt-2 pb-2 md:pt-1 pt-0" data-dismiss="alert">
